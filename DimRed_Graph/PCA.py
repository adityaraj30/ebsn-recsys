...
#Libraries imported for PCA Calculation and Graph Plotting
...
#Scaling Data and Passing through PCA for dimensionality Reduction
def scaling_pca(n2v_embed_np, n=2):
    scaler = StandardScaler()
    standardized_data = scaler.fit_transform(n2v_embed_np)
    pca = PCA(n_components=n)
    reduced_embeddings = pca.fit_transform(standardized_data)
...
def main():
    ...
    n2v_embed_np_red = scaling_pca(n2v_embed_np, 2)
    ...
    n2v_embed_np_red = scaling_pca(n2v_embed_np, 3)
    member_embed_dict = member_embed_map(member_ids, n2v_embed_np_red, member_id_dict)
